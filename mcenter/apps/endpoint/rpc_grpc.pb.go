...
const (
	RPC_RegistryEndpoint_FullMethodName = "/devcloud.mcenter.endpoint.RPC/RegistryEndpoint"
)
...
func (c *rPCClient) RegistryEndpoint(ctx context.Context, in *RegistryRequest, opts ...grpc.CallOption) (*EndpointSet, error) {
	out := new(EndpointSet)
...
func (UnimplementedRPCServer) RegistryEndpoint(context.Context, *RegistryRequest) (*EndpointSet, error) {
...
var RPC_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "devcloud.mcenter.endpoint.RPC",
